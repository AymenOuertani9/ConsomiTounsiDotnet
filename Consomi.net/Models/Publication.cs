...
namespace Consomi.net.Models
{
    public class Publication
    {
        ...
        public virtual User PublicationUser { get; set; }
        ...
        public Publication(int idpub, string topic, DateTime dateTimeOfPublication, string imageUrl, int ratingPoints, int evaluation, List<Commentaire> commentaire, List<Rating> ratings, User publicationUser, List<Commentaire> commentList)
        {
            Idpub = idpub;
            Topic = topic;
